...
namespace CitasEPS.Migrations
{
    ...
    [Migration("20250605174202_AddUniqueConstraintsToUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CitasEPS.Models.Rating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CitasEPS.Models.Doctor", b =>
                {
                    ...
                    b.HasOne("CitasEPS.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("CitasEPS.Models.Patient", b =>
                {
                    b.HasOne("CitasEPS.Models.User", "User")
                        .WithOne("Patient")
                        .HasForeignKey("CitasEPS.Models.Patient", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CitasEPS.Models.Rating", b =>
                {
                    b.HasOne("CitasEPS.Models.Appointment", "Appointment")
                        .WithOne("Rating")
                        .HasForeignKey("CitasEPS.Models.Rating", "AppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
