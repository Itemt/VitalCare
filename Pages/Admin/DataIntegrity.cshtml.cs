            ...
            try
            {
                ...
                foreach (var user in patientsRole)
                {
                    ...
                    if (!hasPatientRecord)
                    {
                        ...
                        ValidationResults.Add(new ValidationIssue
                        {
                            ...
                            Description = $"Usuario con rol Paciente pero sin registro de Patient correspondiente"
                        });
                    }
                    else
                    {
                ...
                foreach (var patient in orphanedPatients)
                {
                    ValidationResults.Add(new ValidationIssue
                    {
                        ...
                        Description = $"Registro de Patient sin usuario correspondiente (Patient ID: {patient.Id})"
                    });
                }
